...
const vietnamAirlines_URL = 'https://baydep.vn/flights/HANSGN25072025/1/0/0?nearby-airport=yes';
...
export async function runCrawler(page, { flightConfig, airports }) {
    ...
    try {
        console.log(`Target : ${vietnamAirlines_URL}\n`);
        ...
        await gotoPage(page, vietnamAirlines_URL, {
