...
const SearchForm = ({ onSubmit, onFromChange, onToChange, selectedTo, isCompactMode }) => {
  ...
  const effectiveTripType = isCompactMode ? 'return' : tripType;
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit({ ...formData, tripType: effectiveTripType, passengers });
  };

  return (
    <form onSubmit={handleSubmit} className={`search-form-container ${isCompactMode ? 'compact-mode' : ''}`}>
      {isCompactMode ? (
        <div className="compact-form-wrapper">
          <div className={`search-form-grid horizontal-layout`}>
            ...
            <div className="form-field passenger-field">
              <label className="form-label">Passengers</label>
              <div className="passenger-selector compact" ref={passengerRef}>
                <button
                  type="button"
      ...
      <div className={`search-form-grid ${isCompactMode ? 'horizontal-layout' : ''}`}>
        <div className="form-field">
          <label className="form-label">From</label>
          <AirportAutocomplete
            name="from"
