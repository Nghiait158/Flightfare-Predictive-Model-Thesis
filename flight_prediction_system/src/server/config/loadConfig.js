...
// Dynamic paths pointing to data directory
const DATA_DIR = path.join(__dirname, '../../../data');
export const AIRPORTS_CSV_PATH = path.join(DATA_DIR, 'airports.csv');
export const FLIGHT_CONFIG_PATH = path.join(DATA_DIR, 'flight-config.json');
export const RESULT_DIR = path.join(DATA_DIR, 'result');
export const SCREENSHOT_DIR = path.join(__dirname, '../../../screenshot');
...
export async function loadFlightConfig(airportsPath = AIRPORTS_CSV_PATH, configPath = FLIGHT_CONFIG_PATH) {
    try {
        ...
        console.log(`                             Flight date: ${flightConfig.search_options.departure_date}`);
