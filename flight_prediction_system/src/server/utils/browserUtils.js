...
import { COOKIE_SELECTORS } from './selectors.js';
...
// Dynamic screenshot path helper
export function getTimestampedScreenshotPath(name) {
    const timestamp = new Date().toISOString().replace(/[:.]/g, '-');
    const screenshotDir = path.join(__dirname, '../../../screenshot');
    return path.join(screenshotDir, `${name}_${timestamp}.png`);
}
